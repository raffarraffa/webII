...
async function crearTrivia(dato) {
    ...
    dato.tipo === 'capital' ?
        ...
        p.innerHTML = `¿A qué país pertenece esta bandera? <br><img class="bandera" src="${pregunta}"></img>`;
    div.appendChild(p);
...
export { obtenerDatosPaises, crearTrivia, verificarTiempoRestante, debug };